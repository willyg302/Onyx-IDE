...
/**
 * Provides a method for consistently augmenting the appearance of a given 
...
public abstract class AbstractComponentDecorator {
    ...
    private final class Listener extends ComponentAdapter 
        ...
        public void componentMoved(ComponentEvent e) {attach();}
        public void componentResized(ComponentEvent e) {attach();}
        public void componentHidden(ComponentEvent e) {setVisible(false);}
        public void componentShown(ComponentEvent e) {setVisible(true);}
    }
}